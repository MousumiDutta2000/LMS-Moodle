...
class __Mustache_249624488e9ca5c8f55b0836582a627c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAa818fa796be515deec7f1f6b36d4c44($context, $indent, $value);
...
';
        $buffer .= $indent . '        ';
        $value = $context->find('slideshow');
        $buffer .= $this->section38c0686c6f343f358e1fac0d18f368c6($context, $indent, $value);
        $buffer .= '
';
...
';
        ...
        $buffer .= $this->sectionC6bfb2c38cf21d714b7b3d54d2d43b85($context, $indent, $value);
    ...
    private function sectionAa818fa796be515deec7f1f6b36d4c44(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawerheading' => array($this, 'block5321be2ff2a09bd9f7fd1ec512777e14'),
                        'drawercontent' => array($this, 'block5d6615dc86dcd5d0bd5ad000a85ccf13'),
    ...
    private function section38c0686c6f343f358e1fac0d18f368c6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' ';
                $value = $this->resolveValue($context->find('slideshow'), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= ' ';
                $context->pop();
            }
...
';
    ...
    private function sectionC6bfb2c38cf21d714b7b3d54d2d43b85(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '    }
';
                $buffer .= $indent . '    $("#promatedcourse-carousel .carousel-item:nth-child(1)").addClass("active");
';
                $buffer .= $indent . '});
';
                $buffer .= $indent . '
';
    ...
    public function block5321be2ff2a09bd9f7fd1ec512777e14($context)
    {
        $indent = $buffer = '';
        $buffer .= '                ';
        $value = $context->find('str');
...
';
    ...
    public function block5d6615dc86dcd5d0bd5ad000a85ccf13($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '                ';
