...
class __Mustache_d077efc1e91ca7db262dedb61b7cca95 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC41210a8646e964637eb03c4749c97c9($context, $indent, $value);
        $value = $context->find('langmenu');
        $buffer .= $this->sectionAfa7987016dcae60a8a185f68a20bdf2($context, $indent, $value);
        $buffer .= $indent . '                ';
...
';
        ...
        $buffer .= $this->section386ac48b175c156bf5bb7fb7e1e4eeed($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                ';
...
';
    ...
    private function sectionC41210a8646e964637eb03c4749c97c9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAfa7987016dcae60a8a185f68a20bdf2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section386ac48b175c156bf5bb7fb7e1e4eeed(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
